...
public class PlayGamesScript : MonoBehaviour
{
    ...
    {
        return JsonUtil.CollectionToJsonString(CloudVariables.SystemValues, "myKey");
    }
    ...
    void StringToGameData(string cloudData, string localData)
    {
        ...
        {
            CloudVariables.SystemValues = cloudArray;
        ...
        else
        {
            for (int i = 0; i < cloudArray.Length; i++)
                ...
                if (localArray[i] > cloudArray[i])
                {
                    ...
                    CloudVariables.SystemValues = localArray;
                    isCloudDataLoaded = true;
    ...
    {
        if (localData != string.Empty)
            CloudVariables.SystemValues = JsonUtil.JsonStringToArray(localData, "myKey",
                                                                        str => int.Parse(str));
    }
